  ...
  <div id="lastfm" class="flex flex-wrap md:-mr-8">
    ...
    <div class="flex flex-wrap w-full mt-1">
      <a href="https://open.spotify.com/user/brodymaclean" target="_blank" class="fill-current mr-8 mb-2 flex items-center">
        <svg height="24" preserveAspectRatio="xMinYMin" viewBox="-2 -2 24 24" width="24" xmlns="http://www.w3.org/2000/svg" class="inline-block mr-2">
      ...
      <a href="https://soundcloud.com/brodymaclean" target="_blank" class="fill-current flex items-center mb-2">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -7.5 24 24" width="24" height="24" preserveAspectRatio="xMinYMin" class="inline-block mr-2">
